    ...
    \subsubsection{Linguaggio per il frontend: TypeScript}\label{subsub:ts}
      ...
      \begin{description}
        ...
        \item[Estensione della sintassi JSX e TSX]
          ...
          % essere in grado di distinguere in modo chiaro i \emph{concetti}\improvement{Non sono sicuro di aver espresso correttamente in italiano ``separation of concerns'', che sarebbe da traduzione separazione di interessi}
