...
% TODO: trasforma elenco puntato in una frase così:
% In letteratura, sono state formalizzate diverse possibili strategie~\cite{7274429} per adottare un livello di astrazione così elevato.
% Una prima strategia, adottata ad esempio nell'approccio \emph{TOTA} (``\emph{Tuples On The Air}''~\cite{10.1145/1538942.1538945}), prevede di rendere le interazioni tra i dispositivi implicite.
% Un secondo approccio, utilizzato nell'\emph{Origami Shape Language}~\cite{nagpal2001programmable}, si basa sulla composizione di costruzioni geometriche e topologiche attraverso operazioni di \emph{folding}.
% Anche modelli di \emph{computazione cloud} come \emph{MapReduce}~\cite{10.1145/1327452.1327492} hanno affrontato il problema dell'astrazione della computazione
...
\begin{itemize}
  ...
  % \item % TODO: modulare + componibile ^
