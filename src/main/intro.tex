...
Nel~\Cref{ch:web} viene fatta riportato il risultato della fase di studio dello stato dell'arte in merito allo sviluppo di sistemi web,
...
Nel~\Cref{ch:motivations} vengono infine esaminate più nel dettaglio le ragioni per le quali il progetto è stato realizzato,
