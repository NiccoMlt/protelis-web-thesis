...
\begin{figure}[htbp]
  ...
  \caption[
    ...
    \nameCref{fig:stack} ripresa da~\cite{7274429}.
  }%
  \label{fig:stack}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption[
    Dettaglio dei livelli più bassi dell'\emph{Aggregate Programming}.
  ]{
    Dettaglio dei livelli più bassi dell'\emph{Aggregate Programming}.

    \nameCref{fig:stack-detail} adattata da~\cite{ProtelisSAC14}.
  }%
...
\begin{description}
  ...
  \item[Riassunto dell'informazione nel tempo] \texttt{T} \\ % Summarising Information Across Time
...
Protelis~\cite{PianiniSASOTutorial2017} è un linguaggio di programmazione aggregato di paradigma funzionale fortemente influenzato da Proto~\cite{Beal2006}.
