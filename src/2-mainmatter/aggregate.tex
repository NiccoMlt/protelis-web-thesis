\chapter{Programmazione aggregata}\label{chap:aggregate}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.65\textwidth]{res/fig/stack-2.png}%
  \caption[
...
% TODO: vedi di fare almeno una pagina
...
% Il framework si struttura su diversi package:
%  TODO: serve scendere nel dettaglio?
