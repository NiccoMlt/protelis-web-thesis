\subsection{Simulatore scelto: Alchemist}\label{subsec:alchemist}
  Alchemist~\cite{alchemist-jos2013} è un meta-simulatore estendibile completamente \engEmph{open-source} che esegue su \engEmph{Java~Virtual~Machine} (JVM), nato all'interno dell'Università di Bologna.
  ...
  \subsubsection{Astrazioni e modello di Alchemist}\label{subsec:modello}
    \begin{figure}[htbp]
      \centering
  ...
  \improvement[inline]{Immagino qui di dover descrivere anche l'incarnazione di Protelis per Alchemist}
