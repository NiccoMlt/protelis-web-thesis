\chapter{Implementazione}\label{ch:implementation}
  ...
  \section{Tecnologie utilizzate}
    ...
    \subsection{Controllo di versione e CI/CD}
      Il controllo di versione utilizzato per questo progetto è affidato al DVCS (\engEmph{Distributed Version Control System}) Git, utilizzato con flusso di lavoro di tipo \emph{Git flow}.
