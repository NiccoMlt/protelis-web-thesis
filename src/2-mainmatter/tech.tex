\section{Tecnologie utilizzate}
  ...
  \subsection{Strumenti per lo sviluppo e il controllo del software}\label{subec:quality}
    ...
    \subsubsection{Backend}
      ...
      Gradle è un sistema per l'automazione dello sviluppo, nato per includere tutte le caratteristiche provenienti da Apache Ant, Maven e Ivy attraverso la definizione di \engEmph{buildscript} originariamente in Groovy e più recentemente anche in Kotlin.
