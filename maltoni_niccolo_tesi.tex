...
\begin{document}
  ...
  \part{Background}\label{part:background}
    \input{src/main/aggregate.tex}
    \input{src/main/web.tex}
    \input{src/main/motivations.tex}

  \part{Contributo: Protelis on Web}\label{part:contribution}
    \input{src/main/requirements.tex}
    \input{src/main/project.tex}
    \input{src/main/implementation.tex}

  \part{Conclusioni}\label{part:conclusion}
    \input{src/main/evaluation.tex}
    \input{src/main/future.tex}
